 ...
 * *.cal files using the pure E4 {@link EditorCalibration}. Eclipse's Project Explorer
 ...
 */
public class CalibrationEditorLauncher extends EditorPart {

	private EditorCalibration editor;
	...
	public void init(IEditorSite site, IEditorInput input) throws PartInitException {
		...
		part.setElementId(EditorCalibration.ID);
		Map<String, Object> map = new HashMap<>();
		map.put(EditorSupport.MAP_FILE, file.getAbsolutePath());
		part.setObject(map);
		editor = new EditorCalibration();
		editor.part = part;
