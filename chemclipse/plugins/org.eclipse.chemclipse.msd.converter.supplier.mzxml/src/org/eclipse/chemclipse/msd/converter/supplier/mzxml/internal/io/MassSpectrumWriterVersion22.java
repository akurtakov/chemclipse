...
public class MassSpectrumWriterVersion22 implements IMassSpectraWriter {
	...
	private void writeMzXML(File file, IScanMSD scanMSD) throws JAXBException {
		...
		marshaller.setProperty(Marshaller.JAXB_SCHEMA_LOCATION, "http://sashimi.sourceforge.net/schema_revision/mzXML_2.2 http://sashimi.sourceforge.net/schema_revision/mzXML_2.2/mzXML_idx_2.2.xsd");
