...
public class TraceRanges1DFieldEditor extends FieldEditor {

	private AtomicReference<TraceRangesEditor1D> editorControl = new AtomicReference<>();

	public TraceRanges1DFieldEditor(String name, String labelText, Composite parent) {
	...
	protected void doFillIntoGrid(Composite parent, int numColumns) {
		...
		TraceRangesEditor1D editor = new TraceRangesEditor1D(parent, SWT.NONE);
