...
public class ChromatogramWSDWriterVersion110 extends AbstractChromatogramWriter implements IChromatogramWSDWriter {

	private static final Logger logger = Logger.getLogger(ChromatogramWSDWriterVersion110.class);
