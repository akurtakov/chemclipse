...
public class DeleteTargetsFilter implements IScanFilter<DeleteTargetsFilterSettings> {
	...
	@Override
	public IProcessingResult<Boolean> filterScans(FilterList<IScan> filterItems, DeleteTargetsFilterSettings configuration, IProgressMonitor monitor) throws IllegalArgumentException {
