...
public class BaselineModel_7_Test {
	...
	public void testBaseline_7() {
		...
		assertEquals(0f, baselineModel.getBackground(4999), 0);
		assertEquals(0f, baselineModel.getBackground(5000), 0);
		assertEquals(0.0f, baselineModel.getBackground(5001), 0);
		assertEquals(0.0f, baselineModel.getBackground(49999), 0);
		assertEquals(0f, baselineModel.getBackground(50000), 0);
		assertEquals(0f, baselineModel.getBackground(50001), 0);
	}
	...
	public void testBaseline_8() {
		...
		assertEquals(1f, baselineModel.getBackground(5000), 0);
		assertEquals(0f, baselineModel.getBackground(4999), 0);
		assertEquals(1f, baselineModel.getBackground(5001), 0);
		assertEquals(0.0f, baselineModel.getBackground(5002), 0);
	}
	...
	public void testBaseline_9() {
		...
		assertEquals(1f, baselineModel.getBackground(4999), 0);
		assertEquals(1f, baselineModel.getBackground(5000), 0);
		assertEquals(1f, baselineModel.getBackground(49999), 0);
		assertEquals(0f, baselineModel.getBackground(50000), 0);
	}
	...
	public void testBaseline_10() {
		...
		assertEquals(0f, baselineModel.getBackground(50001), 0);
		baselineModel.addBaseline(2000, 49999, 1f, 1f, true);
		assertEquals(1f, baselineModel.getBackground(2000), 0);
		assertEquals(1f, baselineModel.getBackground(4999), 0);
		assertEquals(1f, baselineModel.getBackground(5000), 0);
		assertEquals(1f, baselineModel.getBackground(49999), 0);
		assertEquals(0f, baselineModel.getBackground(50000), 0);
		...
		assertEquals(1f, baselineModel.getBackground(2000), 0);
		assertEquals(1f, baselineModel.getBackground(3999), 0);
		assertEquals(2f, baselineModel.getBackground(4000), 0);
		assertEquals(2f, baselineModel.getBackground(4001), 0);
		assertEquals(2f, baselineModel.getBackground(50000), 0);
		assertEquals(2f, baselineModel.getBackground(50001), 0);
		assertEquals(2f, baselineModel.getBackground(60000), 0);
	}
	...
	public void testBaseline_11() {
		...
		assertEquals(100f, baselineModel.getBackground(5000), 0);
		assertEquals(1f, baselineModel.getBackground(5001), 0);
		assertEquals(1f, baselineModel.getBackground(5002), 0);
		assertEquals(100.66f, baselineModel.getBackground(5003), 0);
	}
	...
	public void testBaseline_12() {
		...
		baselineModel.addBaseline(totalScanSignals);
		assertEquals(0f, baselineModel.getBackground(5003), 0);
		assertEquals(1f, baselineModel.getBackground(5004), 0);
		assertEquals(1f, baselineModel.getBackground(5005), 0);
		assertEquals(0f, baselineModel.getBackground(5006), 0);
	}
}
