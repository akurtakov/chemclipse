...
public class IonRange_1_Test {
	...
	public void testSetup_1() {
		...
		assertEquals(1, ionRange.getStartIon());
		assertEquals(5, ionRange.getStopIon());
	}
	...
	public void testSetup_3() {
		...
		assertEquals(IIonRange.MIN_ION, ionRange.getStartIon());
		assertEquals(5, ionRange.getStopIon());
	}
	...
	public void testSetup_4() {
		...
		assertEquals(IIonRange.MIN_ION, ionRange.getStopIon());
	}
