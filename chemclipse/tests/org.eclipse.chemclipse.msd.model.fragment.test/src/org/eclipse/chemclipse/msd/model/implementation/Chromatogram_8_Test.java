...
public class Chromatogram_8_Test {
	...
	public void testGetNumberOfScans_1() {
		...
		assertEquals(80, chromatogram.getNumberOfScans());
	}
	...
	public void testGetMinSignal_1() {
		...
		assertEquals(1, chromatogram.getMinSignal(), 0);
	}

	@Test
	public void testGetMaxSignal_1() {

		assertEquals(100, chromatogram.getMaxSignal(), 0);
	}
	...
	public void testGetTotalIonSignals_1() {
		...
		assertEquals(80, signals.size());
	}

	@Test
	public void testGetTotalIonSignal_1() {

		assertEquals(3840, chromatogram.getTotalSignal(), 0);
	}
	...
	public void testGetScan_1() {
		...
		assertEquals(50.0f, massSpectrum.getTotalSignal(), 0);
	}
	...
	public void testGetScan_2() {
		...
		assertEquals(71.0f, massSpectrum.getTotalSignal(), 0);
	}
}
