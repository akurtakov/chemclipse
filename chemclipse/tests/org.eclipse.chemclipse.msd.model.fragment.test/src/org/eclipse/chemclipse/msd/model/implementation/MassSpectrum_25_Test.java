...
public class MassSpectrum_25_Test {
	...
	public void testGetTotalSignal_1() {
		...
		assertEquals(1229224.9f, massSpectrum2.getTotalSignal(), 0);
	}

	@Test
	public void testGetTotalSignal_2() {

		assertEquals(2302721.0f, mergedMassSpectrum.getTotalSignal(), 0);
	}
	...
	public void testGetTotalSignal_3() {
		...
		assertEquals(95678.2f, ion.getAbundance(), 0);
	}
