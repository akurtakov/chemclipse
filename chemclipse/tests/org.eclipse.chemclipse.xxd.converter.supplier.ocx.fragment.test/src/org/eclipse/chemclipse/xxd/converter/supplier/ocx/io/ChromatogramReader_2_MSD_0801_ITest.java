...
public class ChromatogramReader_2_MSD_0801_ITest {
	...
	public void setUp() {
		...
		File fileImport = new File("testData/files/import/Chromatogram2-0801.ocb");
	...
	public void testEditHistory() {
		...
		GregorianCalendar calendar = new GregorianCalendar(2014, Calendar.AUGUST, 27, 10, 16, 45);
		calendar.set(Calendar.MILLISECOND, 721);
