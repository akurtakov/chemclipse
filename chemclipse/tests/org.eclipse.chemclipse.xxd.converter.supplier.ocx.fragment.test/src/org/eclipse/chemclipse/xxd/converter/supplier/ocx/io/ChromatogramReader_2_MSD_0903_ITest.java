...
public class ChromatogramReader_2_MSD_0903_ITest {
	...
	public void setUp() {
		...
		File fileImport = new File("testData/files/import/Chromatogram2-0903.ocb");
	...
	public void testEditHistory() {
		...
		assertEquals(11, chromatogram.getEditHistory().size());

		assertEquals("Scan Remover Filter", chromatogram.getEditHistory().get(0).getDescription());

		GregorianCalendar calendar = new GregorianCalendar(2014, Calendar.AUGUST, 27, 10, 14, 39);
		calendar.set(Calendar.MILLISECOND, 658);
		calendar.setTimeZone(TimeZone.getTimeZone("Europe/Berlin"));
		assertEquals(calendar.getTime(), chromatogram.getEditHistory().get(0).getDate());

		assertEquals("RTShifter Filter", chromatogram.getEditHistory().get(3).getDescription());
	}
