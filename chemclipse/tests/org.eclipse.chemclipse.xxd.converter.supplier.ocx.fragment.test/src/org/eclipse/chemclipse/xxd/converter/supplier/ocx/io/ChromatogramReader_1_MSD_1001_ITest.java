...
public class ChromatogramReader_1_MSD_1001_ITest {
	...
	public void setUp() {
		...
		File fileImport = new File("testData/files/import/Chromatogram1-1001.ocb");
	...
	public void testEditHistory() {
		...
		GregorianCalendar calendar = new GregorianCalendar(2014, Calendar.AUGUST, 27, 13, 19, 57);
		calendar.set(Calendar.MILLISECOND, 73);
