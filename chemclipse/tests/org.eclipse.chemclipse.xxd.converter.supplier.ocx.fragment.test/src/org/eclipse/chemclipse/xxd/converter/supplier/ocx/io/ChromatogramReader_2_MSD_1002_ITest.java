...
public class ChromatogramReader_2_MSD_1002_ITest {
	...
	public void setUp() {
		...
		File fileImport = new File("testData/files/import/Chromatogram2-1002.ocb");
	...
	public void testEditHistory() {
		...
		GregorianCalendar calendar = new GregorianCalendar(2014, Calendar.NOVEMBER, 05, 13, 57, 35);
		calendar.set(Calendar.MILLISECOND, 543);
