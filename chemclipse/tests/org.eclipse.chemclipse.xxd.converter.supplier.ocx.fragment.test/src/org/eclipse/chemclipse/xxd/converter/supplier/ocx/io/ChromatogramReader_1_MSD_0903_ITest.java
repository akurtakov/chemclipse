...
public class ChromatogramReader_1_MSD_0903_ITest {
	...
	public void setUp() {
		...
		File fileImport = new File("testData/files/import/Chromatogram1-0903.ocb");
	...
	public void testEditHistory() {
		...
		GregorianCalendar calendar = new GregorianCalendar(2014, Calendar.AUGUST, 27, 10, 11, 39);
		calendar.set(Calendar.MILLISECOND, 918);
