...
public class ChromatogramReader_2_MSD_1301_ITest {
	...
	public void setUp() {
		...
		File fileImport = new File("testData/files/import/Chromatogram2-1301.ocb");
	...
	public void testEditHistory() {
		...
		GregorianCalendar calendar = new GregorianCalendar(2015, Calendar.JULY, 23, 11, 56, 30);
		calendar.set(Calendar.MILLISECOND, 75);
