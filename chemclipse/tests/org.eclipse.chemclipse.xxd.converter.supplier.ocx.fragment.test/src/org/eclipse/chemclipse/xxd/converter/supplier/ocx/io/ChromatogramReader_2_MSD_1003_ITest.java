...
public class ChromatogramReader_2_MSD_1003_ITest {
	...
	public void setUp() {
		...
		File fileImport = new File("testData/files/import/Chromatogram2-1003.ocb");
	...
	public void testEditHistory() {
		...
		GregorianCalendar calendar = new GregorianCalendar(2015, Calendar.MAY, 8, 10, 33, 38);
		calendar.set(Calendar.MILLISECOND, 26);
