...
public class ChromatogramReader_1_MSD_1002_ITest {
	...
	public void setUp() {
		...
		File fileImport = new File("testData/files/import/Chromatogram1-1002.ocb");
	...
	public void testEditHistory() {
		...
		GregorianCalendar calendar = new GregorianCalendar(2014, Calendar.NOVEMBER, 5, 13, 55, 40);
		calendar.set(Calendar.MILLISECOND, 64);
