...
public class TraceValidator_03_Test {

	private TraceValidator traceValidator = new TraceValidator();
	private String content = "18 28.2 28.3 28.4 32.1";
	...
	public void test02() {
		...
		assertEquals(28, traces.get(1), 0);
	...
	public void test03() {
		...
		assertEquals("18 28.2 28.3 28.4 32.1", traces);
	}
