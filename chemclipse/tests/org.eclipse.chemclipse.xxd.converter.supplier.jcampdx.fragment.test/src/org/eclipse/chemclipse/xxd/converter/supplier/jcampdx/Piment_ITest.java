...
public class Piment_ITest {
	...
	public void setUp() {
		...
		File file = new File(PathResolver.getAbsolutePath(TestPathHelper.PIMENT));
	...
	public void testSample() {
		...
		assertEquals("Headspace from ground pimento berries", chromatogram.getSampleName());
	}

	@Test
	public void testScans() {

		assertEquals(6000, chromatogram.getNumberOfScans());
	}
}