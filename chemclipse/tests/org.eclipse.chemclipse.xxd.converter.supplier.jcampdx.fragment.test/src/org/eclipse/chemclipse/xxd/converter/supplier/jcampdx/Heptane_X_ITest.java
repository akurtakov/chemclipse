...
public class Heptane_X_ITest {
	...
	public void setUp() {
		...
		File file = new File(PathResolver.getAbsolutePath(TestPathHelper.HEPTANE_X));
	...
	public void test02() {
		...
		assertEquals(700.1f, scanMSD.getRetentionIndex(SeparationColumnType.NON_POLAR));
		assertEquals(700.2f, scanMSD.getRetentionIndex(SeparationColumnType.POLAR));
		assertEquals(700.3f, scanMSD.getRetentionIndex(SeparationColumnType.SEMI_POLAR));
	}
}